...
├── Star
│   └── VariableStar
└── HybridObject (+ ObservableMixin)
```

### Documentation (full API)

This section lists the full public API of the `stellarium_lite` package.
...
<sup>[Back to top](#documentation-full-api)</sup>
