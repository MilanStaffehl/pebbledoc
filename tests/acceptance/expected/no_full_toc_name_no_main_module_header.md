...
#### Table of contents
- [`DEFAULT_CATALOG_NAME`](#stellarium_litedefault_catalog_name)
- [`load_catalog`](#stellarium_liteload_catalog)
- [`CelestialObject`](#stellarium_litecelestialobject)
- [`Star`](#stellarium_litestar)
- [`observation`](#stellarium_liteobservation)
  - [`MAX_MAGNITUDE`](#stellarium_liteobservationmax_magnitude)
  - [`plan_session`](#stellarium_liteobservationplan_session)
  - [`ObservableMixin`](#stellarium_liteobservationobservablemixin)
  - [`VariableStar`](#stellarium_liteobservationvariablestar)
  - [`HybridObject`](#stellarium_liteobservationhybridobject)
  - [`Observation`](#stellarium_liteobservationobservation)
